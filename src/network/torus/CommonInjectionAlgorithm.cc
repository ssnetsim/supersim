 ...
 */
#include "network/torus/CommonInjectionAlgorithm.h"
...
registerWithObjectFactory("common", Torus::InjectionAlgorithm,
                          Torus::CommonInjectionAlgorithm,
                          TORUS_INJECTIONALGORITHM_ARGS);
