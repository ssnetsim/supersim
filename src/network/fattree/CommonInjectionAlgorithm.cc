 ...
 */
#include "network/fattree/CommonInjectionAlgorithm.h"
...
registerWithObjectFactory("common", FatTree::InjectionAlgorithm,
                          FatTree::CommonInjectionAlgorithm,
                          FATTREE_INJECTIONALGORITHM_ARGS);
