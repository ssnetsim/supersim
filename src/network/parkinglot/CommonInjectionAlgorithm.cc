 ...
 */
#include "network/parkinglot/CommonInjectionAlgorithm.h"
...
registerWithObjectFactory("common", ParkingLot::InjectionAlgorithm,
                          ParkingLot::CommonInjectionAlgorithm,
                          PARKINGLOT_INJECTIONALGORITHM_ARGS);
