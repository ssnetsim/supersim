 ...
 */
#include "network/dragonfly/CommonInjectionAlgorithm.h"
...
registerWithObjectFactory("common", Dragonfly::InjectionAlgorithm,
                          Dragonfly::CommonInjectionAlgorithm,
                          DRAGONFLY_INJECTIONALGORITHM_ARGS);
